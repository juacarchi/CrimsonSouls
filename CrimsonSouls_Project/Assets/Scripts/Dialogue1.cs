...
public class Dialogue1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dialogue4.Add("BASTON: AHH... CLARO! ACABAS DE DESPERTAR DEBES ESTAR MUY ATURDIDO Y NO RECORDARAS NADA... TU NOMBRE ES: " + GameManager.instance.name);
        ...
        dialogue5.Add("ESTE BASTON RECOGE LAS ALMAS PERDIDADS PARA SALVARLAS. TIENES QUE SALVAR EL MUNDO OTRA VEZ " + GameManager.instance.name + " ¡VAMOS!");
